...
-- Family Members
-- ------------------------------
INSERT INTO FamilyMembers (FirstName, LastName, Status, ContactPhone, ContactEmail, AddressID)
VALUES
...
-- Reunion Locations
-- ------------------------------
INSERT INTO ReunionLocations (LocationName, LocationDescription, LocationAddress)
VALUES
...
-- Reunions
-- ------------------------------
INSERT INTO Reunions (ReunionName, LocationID, DateOfReunion, FoodProvided, DrinksProvided, SingleCost, FamilyCost)
VALUES
...
-- ------------------------------
INSERT INTO ReunionResponses (FamilyID, ReunionID, AdultCount, ChildCount, DateFeeReceived, FeeAmount)
VALUES
(1, 1, 2, 1, '2025-06-20', 40.00),   -- John & Mary Zastrow + 1 child → Family rate
(4, 1, 1, 1, '2025-06-22', 25.00),   -- Robert + Sarah → Single + child
(6, 2, 2, 2, '2025-09-15', 30.00);   -- Martinez family → Family rate
